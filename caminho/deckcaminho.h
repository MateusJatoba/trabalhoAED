...
void inicializa_personagem(personagem *p){ // incializando o personagem, valores padroes
    p->vida = 20;
    p->energia = 3;
}
...
typedef struct {
    ...
    int tipo[3]; /* tipo da carta: 1-ataque, 2-defesa, 3-especial */
    int valor[3]; /* valor da carta */
    int custo; /* custo da carta */
} tp_carta;

tp_carta minha_carta = {
    .tipo = {1, 2, 3}, //Tipo das cartas
    .valor = {6, 8, 3}, //Valor de cada tipo
    .custo = 2 // Custo de cada carta
};
